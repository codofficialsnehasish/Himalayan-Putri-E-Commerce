...
@php
    use App\Models\Page;
    $page = Page::where('slug', 'category')->orWhere('slug','categorys')->first(); 
@endphp
@section('title')
    {{ $page->meta_title ?? $page->name ?? 'Categorys' }}
@endsection
        ...
        <div class="row justify-content-center">
            <div class="col-xxl-12">
                <div class="breadcrumb__wrapper text-center">
                    <h2 class="breadcrumb__title">Categorys</h2>
        ...
        <div class="row">
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                <div class="bd-product__result mb-30">
                    <h4>{{ $categorys->count() }} Item On List</h4>
                </div>
            </div>
                    ...
                    <div class="product__filter-count d-flex align-items-center">
                        ...
                        <div class="btn-dropdown__options">
                            <select class="show-select" name="show"
                                ...
                                <option value="{{ $categorys->total() }}"
                                    {{ request('show') == $categorys->total() ? 'selected' : '' }}>ALL</option>
                            </select>
                        </div>
