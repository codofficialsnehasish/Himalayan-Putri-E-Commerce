            ...
            <div class="row g-4">
                <div class="col-lg-5">
                    <a href="{{ route('product.all') }}" class="grocery-off__item h-100 bg-image d-block"
                        data-background="{{ asset('assets/site-assets/imgs/grocery/product/off-01.png') }}">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="product-item grocery__product">
                                        ...
                                        <div class="product-content">
                                        <h4 class="product-title"><a href="{{ route('product.details', $featured_product->slug) }}">{{ $featured_product->name }}</a></h4>
