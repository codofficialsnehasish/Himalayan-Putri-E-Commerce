                                    ...
                                    <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                        <div class="product-item">
                                            ...
                                            <div class="product-thumb">
                                                <a href="{{ route('product.details',$product->slug) }}"><img src="{{ getProductMainImage($product->id) }}" alt=""></a>
                                            </div>
                                            <div class="product-action-item">
                                                <button type="button" class="product-action-btn add-to-cart-btn" data-product-id="{{ $product->id }}" data-variation-id="{{ $veriation_id }}" data-product-type="{{ $product->product_type }}">
                                                ...
                                                <button type="button" class="product-action-btn add-to-wishlist" data-product-id="{{ $product->id }}">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <h4 class="product-title"><a href="{{ route('product.details',$product->slug) }}">{{ $product->name }} @if($veriation_name) - {{ $veriation_name }} @endif</a>
                                                </h4>
