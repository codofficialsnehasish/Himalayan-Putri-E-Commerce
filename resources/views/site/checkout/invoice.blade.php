        ...
        <div class="container">
            ...
            <div class="d-md-flex justify-content-between" style="display:flex">
                ...
                <div class="mt-md-0">
                    ...
                    <h4>{{ env('APP_NAME') }}</h4>
                    <ul class="list-unstyled m-0">
                       <li>Shed No:04, Ind. Area, <br>Phase II, Nagrota Bagwan, <br>Himachal Pradesh 176047</li>
                    </ul>
                </div>
            </div>
                ...
                <h5 class="fw-bold my-4">Contact Us</h5>
                    <ul class="list-unstyled">
                        <li><iconify-icon class="social-icon text-primary fs-5 me-2" icon="mdi:location"
                                style="vertical-align:text-bottom"></iconify-icon>Shed No:04, Ind. Area, Phase II, <br>Nagrota Bagwan, Himachal Pradesh 176047</li>
                        <li><iconify-icon class="social-icon text-primary fs-5 me-2" icon="solar:phone-bold"
                                style="vertical-align:text-bottom"></iconify-icon> +91 80914 51734</li>
                        <li><iconify-icon class="social-icon text-primary fs-5 me-2" icon="ic:baseline-email"
                                style="vertical-align:text-bottom"></iconify-icon> info@himalayanputri.com</li>
                    </ul>
                </div>
