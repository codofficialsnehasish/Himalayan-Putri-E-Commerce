                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="Ex : 100% Organic Product" name="heading" value="{{ $slider->heading }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">{{--Slider--}}Product Image</h3>
                                    <div class="card-options ">
                                        <a href="#" class="card-options-collapse" data-toggle="card-collapse"><i class="fe fe-chevron-up"></i></a>
                                        <a href="#" class="card-options-remove" data-toggle="card-remove"><i class="fe fe-x"></i></a>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Discount Image</h3>
                                    <div class="card-options ">
                                        <a href="#" class="card-options-collapse" data-toggle="card-collapse"><i class="fe fe-chevron-up"></i></a>
                                        <a href="#" class="card-options-remove" data-toggle="card-remove"><i class="fe fe-x"></i></a>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="clearfix">
                                        <div class="form-group">
                                            <input type="file" class="dropify" name="discount_image" data-default-file="{{ $slider->getFirstMediaUrl('slider-discount-image') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
