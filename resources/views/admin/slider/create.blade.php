                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="Ex : 100% Organic Product" name="heading" value="{{ old('heading') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="clearfix">
                                        <div class="form-group">
                                            <input type="file" class="dropify" name="discount_image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                <div class="form-group">
                                    <input type="file" class="dropify" name="discount-image">
                                </div>
                            </div>
                        </div>
                    </div> --}}
