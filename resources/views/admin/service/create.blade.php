                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="Enter service title" name="name" value="{{ old('name') }}" required>
                                    @error('name')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <input type="file" class="dropify" name="image" data-allowed-file-extensions="jpg jpeg png webp">
                            </div>
                            @error('image')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
