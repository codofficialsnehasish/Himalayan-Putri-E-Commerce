    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <ul class="nav nav-tabs page-header-tab">
                <li class="nav-item">
                    <a class="btn btn-info" href="{{ route('service.index') }}">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="Enter service title" name="name" value="{{ old('name', $service->title) }}" required>
                                    @error('name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea rows="4" class="form-control no-resize summernote" placeholder="Enter Description" name="description">{{ old('description', $service->description) }}</textarea>
                                    @error('description')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="clearfix">
                                <div class="form-group">
                                    <input type="file" class="dropify" name="image"
                                        data-default-file="{{ $service->getFirstMediaUrl('service-icon') }}">
                                </div>
                            </div>
                            @error('image')
                                <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_visible1" name="is_visible" class="form-check-input"
                                            value="1" {{ check_uncheck($service->is_visible, 1) }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_visible2" name="is_visible" class="form-check-input"
                                            value="0" {{ check_uncheck($service->is_visible, 0) }}>
