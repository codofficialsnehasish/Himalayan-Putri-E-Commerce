        ...
        <div class="d-flex justify-content-between align-items-center">
            <div class="header-action">
                ...
                <ol class="breadcrumb page-breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Offer Banner</li>
                </ol>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="heading" value="{{ old('heading') }}" placeholder="Enter heading" required>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <input type="file" class="dropify" name="image" data-allowed-file-extensions="jpg jpeg png gif webp svg" required>
